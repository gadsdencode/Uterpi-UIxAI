// Visualizations.tsx - Background visual effects for the chat interface
// Includes Particles canvas animation and holographic gradient effects
...
// Main Visualizations component - combines all background effects
...
export { Particles, CircuitPattern };
